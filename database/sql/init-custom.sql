...
DROP DATABASE IF EXISTS `inkuahubdev`;
CREATE DATABASE `inkuahubdev` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `inkuahubdev`;
...
(26,  'humhub\\modules\\space\\activities\\MemberAdded',  'space',  'humhub\\modules\\space\\models\\Space',  1);
...
(39,  'afa06911-047d-45b4-b7f7-45c34bef5058', 'humhub\\modules\\activity\\models\\Activity',  26, 0,  0,  '0',  0,  '2022-08-17 14:50:49',  5,  '2022-08-17 14:50:49',  1,  2,  '2022-08-17 14:50:49',  'activity');
...
(10,  'dff4d9ae-bd6b-491b-aec9-bb9437e16f1b', 'humhub\\modules\\user\\models\\User',  5,  5,  NULL);
...
(10,  'user', 10, 'mustChangePassword', '1');
...
(6, 5,  2,  0,  '2022-08-17 14:50:49',  1,  '2022-08-17 14:50:49',  1);
...
(5, 'Test', 'User', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0,  NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
('humhub\\modules\\activity\\jobs\\SendMailSummary1', '100',  2,  '2022-08-17 13:17:03'),
('humhub\\modules\\activity\\jobs\\SendMailSummary2', '78', 2,  '2022-08-16 18:46:02'),
('search.delete.97742c8dc275176e4020d80538c3769f',  '102',  2,  '2022-08-17 13:43:07'),
...
('search.update.361d0180b3272bc66c0b8d301370686e',  '93', 2,  '2022-08-17 12:50:49'),
...
(14,  'cronLastDailyRun', '1660675562', 'base'),
...
(32,  'cronLastRun',  '1660744142', 'base'),
...
(120, 'cronLastHourlyRun',  '1660742223', 'base'),
...
(129, 'themeParents', '[]', 'base'),
(130, 'theme.var.HumHub.default', '#f3f3f3',  'base'),
(131, 'theme.var.HumHub.primary', '#435f6f',  'base'),
(132, 'theme.var.HumHub.info',  '#21A1B3',  'base'),
(133, 'theme.var.HumHub.success', '#97d271',  'base'),
(134, 'theme.var.HumHub.warning', '#FFC107',  'base'),
(135, 'theme.var.HumHub.danger',  '#FC4A64',  'base'),
(136, 'theme.var.HumHub.link',  '#21A1B3',  'base'),
(137, 'theme.var.HumHub.isFluid', 'false',  'base'),
(138, 'theme.var.HumHub.text-color-main', '#555', 'base'),
(139, 'theme.var.HumHub.text-color-secondary',  '#7a7a7a',  'base'),
(140, 'theme.var.HumHub.text-color-highlight',  '#000', 'base'),
(141, 'theme.var.HumHub.text-color-soft', '#555555',  'base'),
(142, 'theme.var.HumHub.text-color-soft2',  '#aeaeae',  'base'),
(143, 'theme.var.HumHub.text-color-soft3',  '#bac2c7',  'base'),
(144, 'theme.var.HumHub.text-color-contrast', '#fff', 'base'),
(145, 'theme.var.HumHub.background-color-main', '#fff', 'base'),
(146, 'theme.var.HumHub.background-color-secondary',  '#f7f7f7',  'base'),
(147, 'theme.var.HumHub.background-color-page', '#ededed',  'base'),
(148, 'theme.var.HumHub.background-color-highlight',  '#fff8e0',  'base'),
(149, 'theme.var.HumHub.background3', '#d7d7d7',  'base'),
(150, 'theme.var.HumHub.background4', '#b2b2b2',  'base'),
(151, 'theme.var.HumHub.background-color-success',  '#f7fbf4',  'base'),
(152, 'theme.var.HumHub.text-color-success',  '#84be5e',  'base'),
(153, 'theme.var.HumHub.border-color-success',  '#97d271',  'base'),
(154, 'theme.var.HumHub.background-color-warning',  '#fffbf7',  'base'),
(155, 'theme.var.HumHub.text-color-warning',  '#e9b168',  'base'),
(156, 'theme.var.HumHub.border-color-warning',  '#fdd198',  'base'),
(157, 'theme.var.HumHub.background-color-danger', '#fff6f6',  'base'),
(158, 'theme.var.HumHub.text-color-danger', '#ff8989',  'base'),
(159, 'theme.var.HumHub.border-color-danger', '#ff8989',  'base'),
(160, 'theme.var.HumHub.mail-font-url', '\'http://fonts.googleapis.com/css?family=Open+Sans:300,100,400,600\'', 'base'),
(161, 'theme.var.HumHub.mail-font-family',  '\'Open Sans\', Arial, Tahoma, Helvetica, sans-serif',  'base');
...
(1, 5,  NULL, 3,  NULL, NULL, '2022-08-17 14:50:49',  1,  '2022-08-17 14:50:49',  1,  'member', 1,  1,  0,  11);
...
(1, '00178815-0b84-48df-82c3-2c6638b1dc62', 1,  'admin',  'admin@gmail.com',  'local',  '', '2022-08-08 11:00:49',  NULL, '2022-08-08 11:00:49',  NULL, '2022-08-17 13:23:01',  1,  NULL, 1,  NULL),
...
(5, 'dff4d9ae-bd6b-491b-aec9-bb9437e16f1b', 1,  'testuser', 'test@gmail.com', 'local',  'en-US',  '2022-08-17 14:50:49',  1,  '2022-08-17 15:43:07',  1,  NULL, 1,  'Europe/Berlin',  10, NULL);
...
('gag50uaul4v7598gar9r0gmmvb',  1660745372, 1,  '__flash|a:0:{}__captcha/user/auth/captcha|s:7:\"wycagdd\";__captcha/user/auth/captchacount|i:1;__id|i:1;__authKey|s:36:\"00178815-0b84-48df-82c3-2c6638b1dc62\";__expire|i:1660745332;currentAuthClientId|s:5:\"local\";user.canSeeAdminSection|b:1;live.poll.lastQueryTime|i:1660743932;');
...
(4, 5,  'sha512whirlpool',  '5141290c305ef231fef32e996c1eb4421223ec2adf352ebe2fb76be6c6cce164dd3f70db9fab162fce3de4c357447c57febfd4c923332e4cfec20617484375bd', 'fd06f441-49ab-43e1-a9ee-4c888413de24', '2022-08-17 15:43:07');
